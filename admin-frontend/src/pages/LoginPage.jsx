...
function LoginPage() {
  ...
  return (
    <>
      <div className="h-screen flex flex-col gap-3 sm:gap-5 justify-center items-center relative">
        <Banner />
        <form
        ...
        >
          ...
          <div className="relative">
            <input
              ...
              className="block px-2 pb-2 sm:px-2.5 sm:pb-2.5 pt-4 w-[14rem] sm:w-[20rem] text-xs sm:text-lg font-medium text-gray-900 bg-transparent outline-2 outline-gray-300 rounded-md peer focus:outline-2 focus:outline-black"
              placeholder=" "
            />
            <label
              htmlFor="email"
